    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          <h2 className="text-5xl sm:text-6xl lg:text-7xl font-serif font-bold text-white mb-6">
          ...
          <Link href="/songs">
            <Button size="lg" variant="default" className="text-lg px-8" data-testid="button-browse-songs-hero">
              Browse Songs
            </Button>
          </Link>
        </div>
